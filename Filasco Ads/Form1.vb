...
#End Region
    ...
    Public Sub PerformZoom(ByVal Value As Integer)
        Try
            ...
            Dim MyWeb As Object
            MyWeb = Me.globalVOIP.ActiveXInstance
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        'ComboBoxSubject.SelectedIndex = 4
        'ElseIf Label1.Text = 500 Then
        'Label1.Text = 1
        ' End If
...
Corporate Office: 47th street, Suite B3, Brooklyn, NY 11220"
    ...
    Private Sub btnPost_Click(sender As Object, e As EventArgs) Handles btnPost.Click
        Try
            Dim globalElement As HtmlElementCollection = Nothing
            globalElement = globalVOIP.Document.GetElementsByTagName("button")
            For Each curElement As HtmlElement In globalElement
                If InStr(curElement.GetAttribute("classname").ToString, "button button--primary button--icon button--icon--write") Then
    ...
    Private Sub Timer3_Tick(sender As Object, e As EventArgs) Handles Timer3.Tick
        lvlSubjectLength.Text = txtSubject.Text.Length
        lvlBodyLength.Text = txtBody.Text.Length
    End Sub
